            ...
            <div className="flex flex-col items-center gap-1">
              <button
                ...
                className={cn(
                  ...
                  airplaneMode
                    ? "opacity-50 cursor-not-allowed bg-[rgba(var(--accent-color),0.05)] text-[rgba(var(--accent-color),0.3)]"
                    : wifi
                      ? "bg-[rgb(var(--accent-color))] text-black shadow-[0_0_15px_rgba(var(--accent-color),0.4)] hover:scale-105 active:scale-95"
                      : "bg-[rgba(var(--accent-color),0.1)] text-[rgba(var(--accent-color),0.7)] hover:bg-[rgba(var(--accent-color),0.2)] hover:scale-105 active:scale-95",
                )}
              >
                <Wifi className="h-5 w-5" />
              </button>
              <span className="text-[10px] font-medium text-[rgba(var(--accent-color),0.8)]">
                Wi-Fi
              </span>
            </div>
            ...
            <div className="flex flex-col items-center gap-1">
              <button
                ...
                className={cn(
                  ...
                  airplaneMode
                    ? "bg-[rgb(var(--accent-color))] text-black shadow-[0_0_15px_rgba(var(--accent-color),0.4)]"
                    : "bg-[rgba(var(--accent-color),0.1)] text-[rgba(var(--accent-color),0.7)] hover:bg-[rgba(var(--accent-color),0.2)]",
                )}
              >
