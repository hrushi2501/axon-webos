        ...
        <div className="grid grid-cols-4 gap-2 p-2">
          {filteredApps.map((app) => (
            ...
            >
              ...
              <span className="text-[11px] font-medium text-[rgba(var(--accent-color),0.7)] group-hover:text-[rgb(var(--accent-color))] transition-colors">
                {app.title}
              </span>
            </button>
          ))}
      ...
      <div className="flex items-center justify-between p-4 mt-2">
        <div className="flex items-center gap-3 hover:bg-[rgba(var(--accent-color),0.05)] p-2 rounded-xl cursor-pointer transition-colors group">
          ...
          <div className="flex flex-col">
            <span className="text-sm font-medium text-[rgb(var(--accent-color))] group-hover:text-[rgb(var(--accent-color))] transition-colors neon-text">
              Admin
            </span>
          </div>
        </div>
        <button
          type="button"
          title="Restart Axon OS"
          aria-label="Restart Axon OS"
          onClick={() => window.location.reload()}
          className="rounded-xl p-2.5 text-white/50 hover:bg-white/10 hover:text-[rgb(var(--accent-color))] transition-all duration-200 hover:scale-105 active:scale-95"
        >
