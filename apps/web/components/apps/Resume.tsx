                    ...
                    {EDUCATION.map((edu, idx) => (
                        <div key={idx} className="p-4 rounded-lg bg-white/5 border border-white/5 hover:border-white/10 transition-colors">
                            <div className="flex justify-between items-start mb-1">
                                ...
                                <span className="text-xs text-white/50 bg-white/5 px-2 py-1 rounded">{edu.period}</span>
                            </div>
                            <p className="text-white/80">{edu.degree}</p>
                            <div className="flex justify-between mt-2 text-sm text-white/50">
                                <span>{edu.location}</span>
                                <span className="text-[rgb(var(--accent-color))]">CGPA: {edu.gpa}</span>
                            </div>
                        </div>
                    ))}
                </div>
            ...
            <section className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                        <h3 className="text-sm font-medium text-white/60 uppercase tracking-wider">Languages</h3>
                        <div className="flex flex-wrap gap-2">
                            {SKILLS.languages.map(skill => (
                                <span key={skill} className="px-2 py-1 text-xs rounded bg-[rgba(var(--accent-color),0.1)] text-[rgb(var(--accent-color))] border border-[rgba(var(--accent-color),0.2)]">{skill}</span>
                            ))}
                        </div>
                    </div>
                    <div className="space-y-2">
                        <h3 className="text-sm font-medium text-white/60 uppercase tracking-wider">Web Development</h3>
                        <div className="flex flex-wrap gap-2">
                    ...
                    <div className="space-y-2">
                        <h3 className="text-sm font-medium text-white/60 uppercase tracking-wider">Tools</h3>
                        <div className="flex flex-wrap gap-2">
                    ...
                    <div className="space-y-2">
                        <h3 className="text-sm font-medium text-white/60 uppercase tracking-wider">Soft Skills</h3>
                        <div className="flex flex-wrap gap-2">
