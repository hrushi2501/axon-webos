    ...
    return (
        <div className="h-full flex flex-col md:flex-row gap-8 p-6 overflow-y-auto custom-scrollbar">
            ...
            <div className="flex-1 flex flex-col items-center justify-center text-center space-y-6">
                <div>
                    <h2 className="text-3xl font-bold text-white mb-2 neon-text">Get In Touch</h2>
            ...
            <div className="flex-1 flex items-center justify-center">
                <form onSubmit={handleSubmit} className="w-full max-w-md space-y-4 p-6 rounded-2xl bg-white/5 border border-white/10">
