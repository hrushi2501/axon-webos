    ...
    return (
        <div className="flex flex-col items-center justify-center h-full p-8 text-center space-y-6">
            ...
            <div className="space-y-2">
                <h1 className="text-3xl font-bold text-white tracking-tight neon-text">{PROFILE.name}</h1>
            ...
            <div className="flex flex-col items-center gap-3 text-sm text-white/50">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <a href={`mailto:${PROFILE.email}`} className="hover:text-[rgb(var(--accent-color))] transition-colors">{PROFILE.email}</a>
                </div>
                <div className="flex items-center gap-2">
                    <Phone className="w-4 h-4" />
                    <a href={`tel:${PROFILE.phone}`} className="hover:text-[rgb(var(--accent-color))] transition-colors">{PROFILE.phone}</a>
                </div>
            </div>
