...
export const Resume = dynamic(
  () => import("./Resume").then((mod) => mod.Resume),
  { loading: LoadingSpinner },
);
...
export const Contact = dynamic(
  () => import("./Contact").then((mod) => mod.Contact),
  { loading: LoadingSpinner },
);
export const FileManager = dynamic(
  () => import("./FileManager").then((mod) => mod.FileManager),
  { loading: LoadingSpinner },
);
...
export const TaskManager = dynamic(
  () => import("./TaskManager").then((mod) => mod.TaskManager),
  { loading: LoadingSpinner },
);
...
export const Copilot = dynamic(
  () => import("./Copilot").then((mod) => mod.Copilot),
  { loading: LoadingSpinner },
);
